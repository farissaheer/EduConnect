  ...
  return (
    <>
      <div className="bg-gray-200 h-full w-full">
        {/* Code block starts */}
        <nav className="w-full mx-auto hidden xl:block bg-blue-400 shadow">
          <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div className="h-full flex items-center">
              ...
              <ul className="pr-12 xl:flex items-center h-full hidden">
                ...
                <Link to={"/courses"}>
                  <li className="cursor-pointer h-full font-bold flex items-center hover:text-indigo-700 text-sm text-white mx-10 tracking-normal">
                    <h3>COURSES</h3>
                  </li>
                </Link>
                <Link to={"/courses"}>
              ...
              <div className="w-full h-full flex items-center">
                <div className="w-full pr-12 h-full flex items-center border-gray-700">
                  ...
                  <div className="relative w-full">
                    ...
                    <input
                      className="border border-gray-700 focus:outline-none focus:border-indigo-700 w-56 rounded text-sm text-white bg-blue-300 pl-8 py-2 placeholder:text-white"
                      type="text"
                      placeholder="Search"
                    />
                  </div>
                ...
                <div className="w-full h-full flex">
                  ...
                  >
                    {!Login.name && (
                      <Link
                        to="/login"
                        className="cursor-pointer h-full font-bold flex items-center hover:text-indigo-700 text-sm text-white tracking-normal"
                      >
                        LOGIN
                      </Link>
                    )}
