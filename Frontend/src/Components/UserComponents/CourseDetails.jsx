...
const CourseDetails = () => {
  ...
  const handleAddCart = async () => {
    ...
    instance({
      url: "/user/addtocart",
      method: "post",
      data: { courseid: id, userid: userDetails.id },
    }).then((res) => {
      ...
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        ...
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          ...
          <p className=" font-normal text-base leading-6 text-gray-600 mt-7">
            Each programming language has its own syntax, which consists of
            rules and conventions for writing code. Proper syntax is essential
            for code to be understood by computers and other developers.
          </p>
        ...
        <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
          <div>
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              In order to learn about Python 3, we first need to learn about the
              command line! Let's get started. You will learn how to leverage
              the power of Python to solve tasks.!{" "}
            </p>
          </div>
          <div>
            <p className="font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9">
          ...
          <div>
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              ...
              Learn how to install Python on to your computer in an easy step by
              step guide!
            </p>
          </div>
          <div>
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              ...
              personal projects. You will create a portfolio of Python based
              projects you can share. Learn to use Python professionally,
